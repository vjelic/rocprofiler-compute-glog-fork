...
For details about roofline in profiling mode, including command line options and examples (with code samples and expected outputs), see :ref:`roofline-Profiling-options`.
