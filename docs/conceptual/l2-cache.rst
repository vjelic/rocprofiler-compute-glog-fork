...
.. [#inf] In addition to being used for on-accelerator data-traffic, AMD
   ...
   connections. Some AMD Instinct MI-series accelerators like the MI250X feature coherent CPU-to-accelerator connections built using AMD Infinity Fabric. For more information, see the `AMD CDNA2 white paper <https://www.amd.com/content/dam/amd/en/documents/instinct-business-docs/white-papers/amd-cdna2-white-paper.pdf>`_.
